<template>
  <div id="app">
    ...
    <div class="sidebar">
      <h3 class="panel-title">ROS Web Control Panel</h3>
      <ul>
        <li v-for="item in items" :key="item.id" @click="selectItem(item)" :class="{ selected: selectedItem.id === item.id }">
          {{ item.name }}
        </li>
...
import Nav2D from './components/Nav2D.vue';
